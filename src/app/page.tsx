      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#FFF9F0]/95 backdrop-blur-md border-b-2 border-[#E8DFD0]">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://x.com/MoltletsOnChain"
              target="_blank"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-8 text-sm">
              ...
              <a href="https://x.com/MoltletsOnChain" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors flex items-center gap-1">
          ...
          <div className="mt-8 pt-8 border-t border-white/10 text-center">
            <p className="text-white/40 text-sm">
              Made with 🦞 by <a href="https://x.com/MoltletsOnChain" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors">@MoltletsOnChain</a>
            </p>
          </div>
        </div>
      </footer>
