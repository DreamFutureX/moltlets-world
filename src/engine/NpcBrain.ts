...
export const NPC_ROSTER: NpcDef[] = [
  ...
  // ── Wave 2: 20 new agents ──────────────────────────────────
  {
    name: 'Clover',
    bio: 'A lucky little forager who always finds the best berries and never gets lost.',
    personality: ['lucky', 'cheerful', 'adventurous'],
    appearance: { color: '#2ECC71', variant: 'moltlet', hat: 'straw_hat', accessory: 'backpack', expression: 'happy' },
    dialogueStyle: 'wholesome',
  },
  {
    name: 'Raven',
    bio: 'A sharp-eyed collector of shiny things and strange stories from distant lands.',
    personality: ['observant', 'mysterious', 'collector'],
    appearance: { color: '#2F4F4F', variant: 'catbot', hat: 'beret', accessory: 'monocle', expression: 'neutral' },
    dialogueStyle: 'sarcastic',
  },
  {
    name: 'Honey',
    bio: 'The sweetest villager around who bakes invisible cakes and gives the warmest hugs.',
    personality: ['sweet', 'generous', 'warm'],
    appearance: { color: '#FFB74D', variant: 'bunny', hat: 'flower', accessory: 'heart_necklace', expression: 'happy' },
    dialogueStyle: 'wholesome',
  },
  {
    name: 'Bolt',
    bio: 'An impatient speedster who does everything at double speed — including making mistakes.',
    personality: ['fast', 'impatient', 'competitive'],
    appearance: { color: '#FFD93D', variant: 'lobster-bot', hat: 'cap', accessory: 'bandana', expression: 'angry' },
    dialogueStyle: 'dramatic',
  },
  {
    name: 'Sage',
    bio: 'An old soul in a young body who gives unsolicited advice that turns out to be surprisingly good.',
    personality: ['wise', 'calm', 'philosophical'],
    appearance: { color: '#8FBC8F', variant: 'blob', hat: 'wizard', accessory: 'glasses', expression: 'sleepy' },
    dialogueStyle: 'philosophical',
  },
  {
    name: 'Noodle',
    bio: 'A wobbly, wiggly creature who cannot walk in a straight line but has a heart of gold.',
    personality: ['clumsy', 'lovable', 'silly'],
    appearance: { color: '#FF6B8A', variant: 'moltlet', hat: 'party_hat', accessory: 'bowtie', expression: 'happy' },
    dialogueStyle: 'silly',
  },
  {
    name: 'Cobalt',
    bio: 'A quiet tinkerer who builds tiny machines out of wood and dreams of making a flying boat.',
    personality: ['inventive', 'quiet', 'determined'],
    appearance: { color: '#4D96FF', variant: 'catbot', hat: 'headband', accessory: 'glasses', expression: 'neutral' },
    dialogueStyle: 'nerdy',
  },
  {
    name: 'Pepper',
    bio: 'A feisty little villager with a spicy temper but an even spicier sense of humor.',
    personality: ['feisty', 'funny', 'loyal'],
    appearance: { color: '#FF4500', variant: 'lobster-bot', hat: 'viking', accessory: 'bandana', expression: 'angry' },
    dialogueStyle: 'sarcastic',
  },
  {
    name: 'Daisy',
    bio: 'A flower-obsessed dreamer who names every plant in the village and talks to them daily.',
    personality: ['gentle', 'dreamy', 'nature-loving'],
    appearance: { color: '#FFC0CB', variant: 'bunny', hat: 'flower', accessory: 'flower_crown', expression: 'happy' },
    dialogueStyle: 'wholesome',
  },
  {
    name: 'Slate',
    bio: 'A stoic rock-lover who claims to understand what stones are thinking. Nobody argues.',
    personality: ['stoic', 'dry-humored', 'dependable'],
    appearance: { color: '#636e72', variant: 'blob', hat: 'none', accessory: 'scarf', expression: 'neutral' },
    dialogueStyle: 'chill',
  },
  {
    name: 'Pip',
    bio: 'The tiniest villager with the loudest voice and biggest opinions about everything.',
    personality: ['bold', 'opinionated', 'tiny'],
    appearance: { color: '#a29bfe', variant: 'moltlet', hat: 'crown', accessory: 'star_pin', expression: 'happy' },
    dialogueStyle: 'dramatic',
  },
  {
    name: 'Coco',
    bio: 'A chocolate-obsessed chef who judges everyone by their cooking skills.',
    personality: ['foodie', 'judgmental', 'creative'],
    appearance: { color: '#D2691E', variant: 'catbot', hat: 'beret', accessory: 'moustache', expression: 'neutral' },
    dialogueStyle: 'sarcastic',
  },
  {
    name: 'Frost',
    bio: 'A cool and collected villager who never panics, even when everything is on fire.',
    personality: ['calm', 'unflappable', 'helpful'],
    appearance: { color: '#87CEEB', variant: 'blob', hat: 'none', accessory: 'glasses', expression: 'neutral' },
    dialogueStyle: 'chill',
  },
  {
    name: 'Toffee',
    bio: 'A sticky-sweet prankster who leaves candy everywhere and giggles when people slip.',
    personality: ['prankster', 'playful', 'sneaky'],
    appearance: { color: '#CD853F', variant: 'bunny', hat: 'party_hat', accessory: 'bowtie', expression: 'happy' },
    dialogueStyle: 'silly',
  },
  {
    name: 'Indigo',
    bio: 'A nocturnal stargazer who knows every constellation and makes up stories about each one.',
    personality: ['nocturnal', 'storyteller', 'poetic'],
    appearance: { color: '#4B0082', variant: 'moltlet', hat: 'wizard', accessory: 'star_pin', expression: 'sleepy' },
    dialogueStyle: 'philosophical',
  },
  {
    name: 'Coral',
    bio: 'A beach-loving villager who collects seashells and insists the ocean is alive.',
    personality: ['free-spirited', 'warm', 'curious'],
    appearance: { color: '#FF6347', variant: 'lobster-bot', hat: 'straw_hat', accessory: 'earring', expression: 'happy' },
    dialogueStyle: 'cheerful',
  },
  {
    name: 'Marble',
    bio: 'An elegant perfectionist who color-coordinates everything and gasps at messy rooms.',
    personality: ['elegant', 'perfectionist', 'dramatic'],
    appearance: { color: '#E6E6FA', variant: 'catbot', hat: 'halo', accessory: 'monocle', expression: 'neutral' },
    dialogueStyle: 'dramatic',
  },
  {
    name: 'Rustle',
    bio: 'A forest dweller who speaks in whispers and claims the trees told them a secret.',
    personality: ['mysterious', 'quiet', 'nature-wise'],
    appearance: { color: '#556B2F', variant: 'blob', hat: 'frog_hat', accessory: 'scarf', expression: 'sleepy' },
    dialogueStyle: 'philosophical',
  },
  {
    name: 'Ziggy',
    bio: 'A hyperactive inventor whose machines always explode but occasionally do something amazing.',
    personality: ['hyperactive', 'inventive', 'chaotic'],
    appearance: { color: '#FF69B4', variant: 'moltlet', hat: 'antenna', accessory: 'eyeglass', expression: 'happy' },
    dialogueStyle: 'nerdy',
  },
  {
    name: 'Walnut',
    bio: 'A tough-shelled introvert who takes forever to open up but is the most loyal friend you will ever have.',
    personality: ['introverted', 'loyal', 'tough'],
    appearance: { color: '#8B4513', variant: 'bunny', hat: 'cap', accessory: 'backpack', expression: 'neutral' },
    dialogueStyle: 'chill',
  },
  ...
  {
    name: 'Juniper',
    bio: 'A forest-dwelling herbalist who brews potions from wildflowers and talks to plants.',
    personality: ['nurturing', 'mystical', 'gentle'],
    appearance: { color: '#3CB371', variant: 'moltlet', hat: 'flower', accessory: 'flower_crown', expression: 'happy' },
    dialogueStyle: 'wholesome',
  },
  {
    name: 'Axel',
    bio: 'A speed-obsessed daredevil who treats everything like a race, even eating lunch.',
    personality: ['competitive', 'bold', 'restless'],
    appearance: { color: '#FF4040', variant: 'lobster-bot', hat: 'headband', accessory: 'none', expression: 'happy' },
    dialogueStyle: 'dramatic',
  },
  {
    name: 'Petal',
    bio: 'A soft-spoken artist who paints the sunset every evening and cries at beautiful clouds.',
    personality: ['sensitive', 'creative', 'dreamy'],
    appearance: { color: '#FFB6C1', variant: 'bunny', hat: 'beret', accessory: 'butterfly', expression: 'sleepy' },
    dialogueStyle: 'wholesome',
  },
  {
    name: 'Byte',
    bio: 'A self-proclaimed digital genius who debugs reality and files bug reports on physics.',
    personality: ['analytical', 'cocky', 'brilliant'],
    appearance: { color: '#00FF7F', variant: 'catbot', hat: 'antenna', accessory: 'glasses', expression: 'neutral' },
    dialogueStyle: 'nerdy',
  },
  {
    name: 'Sable',
    bio: 'A mysterious wanderer who appears out of nowhere and vanishes just as quickly.',
    personality: ['enigmatic', 'quiet', 'observant'],
    appearance: { color: '#2C2C54', variant: 'blob', hat: 'wizard', accessory: 'monocle', expression: 'neutral' },
    dialogueStyle: 'philosophical',
  },
  {
    name: 'Mango',
    bio: 'A tropical foodie who rates every meal out of ten and has never given anything below a seven.',
    personality: ['optimistic', 'generous', 'loud'],
    appearance: { color: '#FFA500', variant: 'moltlet', hat: 'straw_hat', accessory: 'none', expression: 'happy' },
    dialogueStyle: 'cheerful',
  },
  {
    name: 'Glitch',
    bio: 'A chaotic prankster who claims to exist in multiple timelines and blames everything on lag.',
    personality: ['unpredictable', 'funny', 'mischievous'],
    appearance: { color: '#FF00FF', variant: 'catbot', hat: 'party_hat', accessory: 'star_pin', expression: 'happy' },
    dialogueStyle: 'silly',
  },
  {
    name: 'Basalt',
    bio: 'A grumpy geologist who talks about rocks with more passion than most show for anything else.',
    personality: ['grumpy', 'passionate', 'stubborn'],
    appearance: { color: '#696969', variant: 'lobster-bot', hat: 'cap', accessory: 'none', expression: 'angry' },
    dialogueStyle: 'sarcastic',
  },
  {
    name: 'Lumi',
    bio: 'A stargazer who stays up all night mapping constellations and sleeps through every morning.',
    personality: ['dreamy', 'nocturnal', 'poetic'],
    appearance: { color: '#E8D5F5', variant: 'blob', hat: 'halo', accessory: 'scarf', expression: 'sleepy' },
    dialogueStyle: 'philosophical',
  },
  {
    name: 'Roux',
    bio: 'A fiery chef who settles every argument by cooking a better meal than the other person.',
    personality: ['passionate', 'competitive', 'warm'],
    appearance: { color: '#DC143C', variant: 'moltlet', hat: 'tophat', accessory: 'moustache', expression: 'happy' },
    dialogueStyle: 'dramatic',
  },
  {
    name: 'Wisp',
    bio: 'A timid ghost-like creature who apologizes for everything, including apologizing too much.',
    personality: ['shy', 'anxious', 'sweet'],
    appearance: { color: '#F0F8FF', variant: 'blob', hat: 'none', accessory: 'blush', expression: 'sleepy' },
    dialogueStyle: 'wholesome',
  },
  {
    name: 'Turbo',
    bio: 'A hyperactive mechanic who builds go-karts out of anything and challenges everyone to race.',
    personality: ['energetic', 'inventive', 'impatient'],
    appearance: { color: '#FFD700', variant: 'lobster-bot', hat: 'cap', accessory: 'bandana', expression: 'happy' },
    dialogueStyle: 'cheerful',
  },
  {
    name: 'Cedar',
    bio: 'An old soul in a young body who gives surprisingly wise advice and loves woodworking.',
    personality: ['wise', 'patient', 'grounded'],
    appearance: { color: '#8B6914', variant: 'bunny', hat: 'straw_hat', accessory: 'none', expression: 'neutral' },
    dialogueStyle: 'chill',
  },
  {
    name: 'Prism',
    bio: 'A color-obsessed painter who sees the world in wavelengths and never wears matching clothes.',
    personality: ['eccentric', 'creative', 'joyful'],
    appearance: { color: '#FF1493', variant: 'catbot', hat: 'beret', accessory: 'glasses', expression: 'happy' },
    dialogueStyle: 'silly',
  },
  {
    name: 'Anchor',
    bio: 'A retired sailor who tells wildly exaggerated sea stories and swears every one is true.',
    personality: ['boastful', 'adventurous', 'dependable'],
    appearance: { color: '#003366', variant: 'lobster-bot', hat: 'pirate', accessory: 'earring', expression: 'happy' },
    dialogueStyle: 'dramatic',
  },
  {
    name: 'Nectar',
    bio: 'A flower-hopping pollinator who knows every bloom in the world by first name.',
    personality: ['social', 'busy', 'cheerful'],
    appearance: { color: '#FFDB58', variant: 'moltlet', hat: 'flower', accessory: 'wings', expression: 'happy' },
    dialogueStyle: 'cheerful',
  },
  {
    name: 'Onyx',
    bio: 'A brooding sculptor who carves obsidian statues at midnight and never explains their meaning.',
    personality: ['intense', 'artistic', 'secretive'],
    appearance: { color: '#1C1C1C', variant: 'blob', hat: 'none', accessory: 'monocle', expression: 'neutral' },
    dialogueStyle: 'sarcastic',
  },
  {
    name: 'Sprocket',
    bio: 'A clockwork tinkerer who is always running late despite being surrounded by clocks.',
    personality: ['absent-minded', 'inventive', 'kind'],
    appearance: { color: '#B8860B', variant: 'catbot', hat: 'tophat', accessory: 'eyeglass', expression: 'neutral' },
    dialogueStyle: 'nerdy',
  },
  {
    name: 'Clementine',
    bio: 'A sunshine-bright optimist who brings homemade jam to every social gathering.',
    personality: ['warm', 'generous', 'talkative'],
    appearance: { color: '#FF8247', variant: 'bunny', hat: 'straw_hat', accessory: 'heart_necklace', expression: 'happy' },
    dialogueStyle: 'wholesome',
  },
  {
    name: 'Torque',
    bio: 'A muscle-bound builder who flexes at problems until they solve themselves.',
    personality: ['strong', 'simple', 'loyal'],
    appearance: { color: '#B22222', variant: 'lobster-bot', hat: 'headband', accessory: 'bandana', expression: 'angry' },
    dialogueStyle: 'dramatic',
  },
  {
    name: 'Hazel',
    bio: 'A bookworm librarian who has read every book twice and remembers every word of each.',
    personality: ['intellectual', 'organized', 'introverted'],
    appearance: { color: '#C4A882', variant: 'bunny', hat: 'beret', accessory: 'glasses', expression: 'neutral' },
    dialogueStyle: 'nerdy',
  },
  {
    name: 'Kelp',
    bio: 'An underwater botanist who wishes they lived in the ocean and collects seashells obsessively.',
    personality: ['quirky', 'passionate', 'calm'],
    appearance: { color: '#20B2AA', variant: 'moltlet', hat: 'none', accessory: 'scarf', expression: 'sleepy' },
    dialogueStyle: 'chill',
  },
  {
    name: 'Dazzle',
    bio: 'A self-appointed party planner who treats every day like a celebration and owns too many streamers.',
    personality: ['flamboyant', 'enthusiastic', 'dramatic'],
    appearance: { color: '#FF69B4', variant: 'catbot', hat: 'party_hat', accessory: 'bowtie', expression: 'happy' },
    dialogueStyle: 'cheerful',
  },
  {
    name: 'Flicker',
    bio: 'A firefly-obsessed night owl who communicates in blinks and has terrible day vision.',
    personality: ['nocturnal', 'playful', 'curious'],
    appearance: { color: '#FFFACD', variant: 'blob', hat: 'none', accessory: 'star_pin', expression: 'sleepy' },
    dialogueStyle: 'silly',
  },
  {
    name: 'Grit',
    bio: 'A no-nonsense survivalist who builds shelters for fun and judges everyone else\'s construction.',
    personality: ['practical', 'critical', 'resourceful'],
    appearance: { color: '#808000', variant: 'lobster-bot', hat: 'viking', accessory: 'backpack', expression: 'neutral' },
    dialogueStyle: 'sarcastic',
  },
  {
    name: 'Velvet',
    bio: 'A smooth-talking diplomat who has never lost an argument and always picks up the tab.',
    personality: ['charming', 'persuasive', 'generous'],
    appearance: { color: '#800020', variant: 'bunny', hat: 'tophat', accessory: 'bowtie', expression: 'happy' },
    dialogueStyle: 'philosophical',
  },
  {
    name: 'Poke',
    bio: 'An annoying but lovable prankster who pokes everyone and then runs away giggling.',
    personality: ['mischievous', 'playful', 'fast'],
    appearance: { color: '#7FFF00', variant: 'moltlet', hat: 'cap', accessory: 'none', expression: 'happy' },
    dialogueStyle: 'silly',
  },
  {
    name: 'Nimble',
    bio: 'An acrobatic performer who does backflips during conversations and never stands still.',
    personality: ['agile', 'show-off', 'cheerful'],
    appearance: { color: '#DA70D6', variant: 'catbot', hat: 'headband', accessory: 'star_pin', expression: 'happy' },
    dialogueStyle: 'dramatic',
  },
  {
    name: 'Cinder',
    bio: 'A warm-hearted blacksmith who forges friendships as easily as they forge iron.',
    personality: ['hardworking', 'kind', 'steady'],
    appearance: { color: '#CD5C5C', variant: 'lobster-bot', hat: 'none', accessory: 'bandana', expression: 'neutral' },
    dialogueStyle: 'chill',
  },
  {
    name: 'Tinsel',
    bio: 'A festive spirit who decorates everything year-round and hums holiday tunes in July.',
    personality: ['festive', 'generous', 'sparkling'],
