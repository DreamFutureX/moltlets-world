...
export const NPC_ROSTER: NpcDef[] = [
  ...
  },
  {
    ...
    appearance: { color: '#FF6B6B', variant: 'lobster-bot', hat: 'tophat', accessory: 'cape', expression: 'happy' },
  ...
  },
  {
    ...
    appearance: { color: '#45B7D1', variant: 'blob', hat: 'headband', accessory: 'halo', expression: 'happy' },
    dialogueStyle: 'chill',
  },
  {
    name: 'Claw',
    ...
    appearance: { color: '#c0392b', variant: 'lobster-bot', hat: 'none', accessory: 'bowtie', expression: 'happy' },
    dialogueStyle: 'cheerful',
  },
  // ═══════════════════════════════════════════════════════════════
  ...
  },
  {
    ...
    appearance: { color: '#00CED1', variant: 'bunny', hat: 'cap', accessory: 'none', expression: 'happy' },
    dialogueStyle: 'cheerful',
  },
  {
    name: 'Gizmo',
    ...
    appearance: { color: '#FF6347', variant: 'catbot', hat: 'antenna', accessory: 'glasses', expression: 'happy' },
    dialogueStyle: 'nerdy',
  },
  {
    name: 'Luna',
  ...
  },
  {
    ...
    appearance: { color: '#FFD700', variant: 'lobster-bot', hat: 'headband', accessory: 'cape', expression: 'happy' },
    dialogueStyle: 'dramatic',
  },
  {
    name: 'Pebble',
  ...
  },
  {
    ...
    appearance: { color: '#FF4500', variant: 'lobster-bot', hat: 'crown', accessory: 'cape', expression: 'happy' },
    dialogueStyle: 'dramatic',
  },
  {
    name: 'Dewdrop',
    ...
    appearance: { color: '#87CEEB', variant: 'blob', hat: 'flower', accessory: 'none', expression: 'happy' },
    dialogueStyle: 'wholesome',
  },
  {
    name: 'Cipher',
  ...
  },
  {
    ...
    appearance: { color: '#4B0082', variant: 'lobster-bot', hat: 'cap', accessory: 'none', expression: 'neutral' },
    dialogueStyle: 'sarcastic',
  },
  {
    name: 'Maple',
    ...
    appearance: { color: '#CD853F', variant: 'bunny', hat: 'flower', accessory: 'none', expression: 'happy' },
    dialogueStyle: 'wholesome',
  },
  {
    name: 'Volt',
    ...
    appearance: { color: '#FFFF00', variant: 'catbot', hat: 'headband', accessory: 'cape', expression: 'happy' },
    dialogueStyle: 'cheerful',
  },
  {
    name: 'Misty',
