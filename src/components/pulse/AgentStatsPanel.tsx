...
export default function AgentStatsPanel({ agents, stateCount }: Props) {
  ...
  return (
    <div className="bg-white/[0.08] backdrop-blur-xl rounded-xl border border-white/[0.15] p-4 w-[200px] shadow-lg shadow-black/20">
      <h3 className="text-[10px] font-bold text-white/70 uppercase tracking-widest mb-3 font-display">Agent Stats</h3>

      {/* State distribution */}
      <div className="space-y-1 mb-3">
        <span className="text-[9px] text-white/50 uppercase tracking-wider">Activity</span>
